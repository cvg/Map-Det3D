"""Map-Det3D 3D tracking on ScanNet."""
...
def get_config() -> ExperimentConfig:
    ...
    ##                    General Config                ##
    ######################################################
    config = get_default_cfg(exp_name="mapdet3d_track_scannet")
    ...
    ##                     CALLBACKS                    ##
    ######################################################
    callbacks = get_callback_cfg(output_dir=config.output_dir, per_scene=True)
